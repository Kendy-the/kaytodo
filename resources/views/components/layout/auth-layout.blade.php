...
<head>
    ...
    <title>@yield('title','Auth - KayTODO')</title>
</head>

<body class="bg-gray-100">
    <header class=" bg-violet-500 fixed w-full text-white">
        <nav class="border-gray-200">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                <a href="/auth/login" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap">Kay TODO</span>
                </a>
    ...
    <footer class="bg-violet-800 text-white">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="/" class="flex items-center">
                        <span class="self-center text-2xl font-semibold whitespace-nowrap">Kay
                            TODO</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-300 font-medium">
                            ...
                            <li>
                                <a href="#" class="hover:text-white hover:underline">Discord</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-300 sm:text-center">© 2023 <a href="#"
                        class="hover:underline hover:text-white">KayTODO™</a>. All Rights Reserved.
                </span>
