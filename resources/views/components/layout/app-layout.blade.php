        ...
        <nav class="nav">
            <div>
                <div class="nav_list">
                    ...
                    <a href="/task" @class([
                                    'nav_link',
                                'active' => str_contains(((request()->route()) != null ? request()->route()->getName() : ' '), 
                                'task'),
                            ])>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <path
                        ...
                        <span class="nav_name">Attendant</span>
                    </a>
                    <a href="/category" @class([
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;"><path d="M10 3H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM9 9H5V5h4v4zm5 2h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1h-6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1zm1-6h4v4h-4V5zM3 20a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v6zm2-5h4v4H5v-4zm8 5a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-6a1 1 0 0 0-1 1v6zm2-5h4v4h-4v-4z"></path></svg>
    ...
    <footer style="transform: translateX(-50%);"
        ...
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            ...
            @class([
                    ...
                    'bg-gray-800' => str_contains(((request()->route()) != null ? request()->route()->getName() : ' '), 
                    'home'),
            ...
            <a href="/project" @class(['inline-flex flex-col items-center justify-center px-5 dark:hover:bg-gray-800 group rounded-full',
                                'bg-gray-800' => str_contains(((request()->route()) != null ? request()->route()->getName() : ' '), 
                                'project'),
            ...
            @class([
                ...
                <span class="sr-only">Attendant</span>
            </a>
