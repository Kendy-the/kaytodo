<x-layout.auth-layout>
    ...
    <x-poppup>
        ...
        <x-status>
            <x-slot:title>Welcome To Kay TODO</x-slot:title>
            <x-slot:content>
            ...
            <x-slot:button-action>/account/profile</x-slot:button-action>
            <x-slot:button-name>Set Up My Profile</x-slot:button-name>
            <x-slot:button-action1>/home</x-slot:button-action1>
            <x-slot:button-name1>Explore The App First</x-slot:button-name1>
        </x-status>
    </x-poppup>
