<x-layout.auth-layout>
    ...
    <x-poppup>
        <x-slot:notice-icone>
            <svg class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" width="48"
        ...
        <x-otp :choice="'pin'">
            ...
            <x-slot:content>
                A verification code will be sent to{{ isset($email) ? "the email {$email}" : 'your email' }} for your
