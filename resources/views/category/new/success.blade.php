<x-layout.auth-layout>
    ...
    @section('title', 'Create Category Success')
    ...
    <x-poppup>
        ...
        <x-status>
            <x-slot:title>Category Created!</x-slot:title>
            <x-slot:content>
                Congratulations! you have been created your category successfully!
            </x-slot:content>
            <x-slot:button-action>/category</x-slot:button-action>
