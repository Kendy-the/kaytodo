                    ...
                    @if (isset($post->messages[0]))
                        <div>
                            <div class="flex justify-between">
                                ...
                                @empty
                                    @php $empty = true @endphp
                                    <h2 class="font-bold mb-1 me-1">{{ $post->invite->email }}</h2>
                                @endforelse

                                @if($trouver)
                                    <h2 class="font-bold mb-1 me-1">{{ $post->invite->first_name }}</h2>
                                @else
                                    @if(!$empty)
                                        <h2 class="font-bold mb-1 me-1">{{ $post->invite->email }}</h2>
                                    @endif
                    ...
                    @if (isset($post->messages[0]))
                        <div>
                            <div class="flex justify-between">
                                ...
                                @empty
                                    @php $empty = true @endphp
                                    <h2 class="font-bold mb-1 me-1">{{ $post->user->email }}</h2>
                                @endforelse

                                @if($trouver)
                                    <h2 class="font-bold mb-1 me-1">{{ $post->user->first_name }}</h2>
                                @else
                                    @if(!$empty)
                                        <h2 class="font-bold mb-1 me-1">{{ $post->user->email }}</h2>
                                    @endif
