...
@else
    {{-- s'il y'a message --}}
    <div class="h-dvh overflow-y-scroll pb-40">
        {{-- s'il y'a message --}}
        <a href="/account/message/show/{{ isset($message) && !empty($message) ? $message->id : 1 }}" class="flex  gap-2 justify-around border-t my-1 px-2 py-3 border-gray-200">
            <div>
