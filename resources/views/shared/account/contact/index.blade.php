...
@else
    ...
    <div class="h-dvh overflow-y-scroll pb-40">
        <div class="flex justify-around gap-2 border-t my-1 py-3 border-gray-200">
            <div>
            ...
            <div class="{{ $position }} group">
                <div class="flex justify-between">
                    <h2 class="inline-block font-bold text-lg mb-1">{{ isset($name) && !empty($name) ? $name : 'Jhon Doe'}}</h2>
                    <a href="/account/contact/delete/{{isset($id) ? $id : '1'}}" class="text-red-700 lg:text-gray-100 lg:group-hover:text-red-700 font-bold text-2xl cursor-pointer"><i class='bx bx-user-x'></i></a>
                </div>
                <div class="flex justify-between items-center gap-7">
                    <p>{{ isset($contact) && !empty($contact) ? substr($contact,0,20) . '...' : "jhonedoe@gmail.com"}}</p>
                </div>
            </div>
        </div>
    </div>
