<x-layout.auth-layout>
    ...
    <x-poppup>
        ...
        <x-otp :choice="'pin'">
            ...
            <x-slot:content>
                A verification code will be sent to{{ isset($email) ? "the email {$email}" : 'your email' }} to continue the password
                reset process.
            </x-slot:content>
            <x-slot:action1>/account/profile</x-slot:action1>
        </x-otp >
    </x-poppup>
</x-layout.auth-layout>