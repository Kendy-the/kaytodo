<x-layout.app-layout>
    ...
    <div class="container pt-3 pe-2 overflow-y-auto h-dvh pb-20 md:pb-5">
        <form action="/account/profile/edit" enctype="multipart/form-data" method="post">
            @csrf
            <div class="bg-white rounded-xl p-10 pb-3 mt-5">
                ...
                <div class="flex flex-col items-center justify-center mt-2">
                    ...
                    <div class="text-center">format should be in .jpeg, .png atleast 800x800px and less than 4MB
                    </div>
                </div>
                ...
                <div class="mt-3 flex flex-col gap-4 pb-3">
                    ...
                    <div class="w-full md:w-auto">
                        ...
                        <x-input :label="'Last Name'" :value="$user->last_name" :type="'text'" :name="'last_name'" :$hasError
                            readonly>
                    ...
                    <div class="w-full md:w-auto">
                        ...
                        <x-input :label="'Firs Name'" :value="$user->first_name" :type="'text'" :name="'first_name'" :$hasError
                            readonly>
                    ...
                    <div class="w-full md:w-auto">
                        ...
                        <x-input :label="'Email'" :value="$user->email" :type="'email'" :name="'email'" :$hasError
                            readonly>
