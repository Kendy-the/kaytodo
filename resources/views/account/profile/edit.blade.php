                ...
                <div class="mt-3 flex flex-col gap-4 pb-3">
                    ...
                    <div class="w-full md:w-auto">
                        @php $hasError = 'none' @endphp
                            ...
                            <x-input :label="'Profession'" :value="''" :type="'text'" :name="'profession'" :$hasError>
                ...
                <div class="mt-3 flex flex-col gap-4 pb-3">
                    <div class="w-full md:w-auto">
                        @php $hasError = 'none' @endphp
                            ...
                            <x-input :label="'Country'" :value="''" :type="'text'" :name="'country'" :$hasError>
                    ...
                    <div class="w-full md:w-auto">
                        @php $hasError = 'none' @endphp
                            ...
                            <x-input :label="'State'" :value="''" :type="'text'" :name="'state'" :$hasError>
                    ...
                    <div class="w-full md:w-auto">
                        @php $hasError = 'none' @endphp
                            ...
                            <x-input :label="'City'" :value="''" :type="'text'" :name="'city'" :$hasError>
                                <x-slot:placeholder>My state</x-slot:placeholder>
                                @error('city')
                                    <x-slot:input-error>
                                        <p class="text-[12px] text-red-500 mt-1">{{ $message }}</p>
                    ...
                    <div class="w-full md:w-auto">
                        ...
                        <textarea
                            ...
                            type="text" name="other" placeholder="Other, I want to save" id=""></textarea>
                    </div>
                </div>
            </div>
            <div class="mt-3">
